...
struct ShortVideoCellView: View {
  ...
  //  var color: Color
   ...
   // @Binding var dismiss: Bool
    ...
    /*
     init(viewModel: FeedCellViewModel, postWidth: CGFloat, forFeed: Bool) {
     self.viewModel = viewModel
     self.postWidth = postWidth
     self.forFeed = forFeed
     }*/
              ...
              //  .frame(width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height, alignment: .center)
                ...
                .actionSheet(isPresented: $showingActionSheet) {
                    ActionSheet(title: Text("Settings"), buttons: [
                        .default(Text("View Comments")) {  },
                        .default(Text("View Sources")) { },
                        .default(Text("Report")) { },
                        .cancel()
                    ])
                }*/
